...
function buyGame (idResp) {
    ...
    xhttp.open(
            "POST", "../driver/create_factura.php?idResp="+idResp+"&idProduct="+idgame+"&fecha="+fullDate+'&kindProduct=dlc',
            true);
    xhttp.send(null);
}
...
function showDescGame (idGame, nameGame, precio) {
    ...
    xhttp.open(
            "POST", "../driver/description_dlc.php?idDLC="+idGame+'&nameDlc='+nameGame+'&precio='+precio+'&user_id='+user_id,
            true);
    xhttp.send(null);
}
